%% ===================================================================
%% CLASSE DE DOCUMENTO E PACOTE DE ESTILO UNOESC
%% ===================================================================
\documentclass[
  article,      % Tipo de documento
  a4paper,      % Tamanho do papel (ABNT)
  12pt,         % Tamanho da fonte (ABNT)
  oneside,      % Impressão em um lado
  fleqn         % Alinhamento de equações à esquerda
]{abntex2}

%% --- Pacote de estilo da UNOESC ---
% Carrega todas as configurações de margens, fontes, cores e referências.
% ABNTNum=brkt: Ativa o estilo numérico com colchetes [1]
\usepackage[ABNTNum=brkt]{unoesc-article}

%% --- Arquivo de referências ---
% As suas referências bibliográficas devem ser adicionadas neste arquivo.
...
% As afiliações e contatos são adicionados com \thanks, \affil e \email
\autor{
  Alexandre Reitemeyer\thanks{\affil{Curso de Sistemas de Informação, UNOESC, Chapecó}\sep\email{aluno1@edu.unoesc.br}} \and
  Angelo Pandolfo Antonini\thanks{\affil{Curso de Sistemas de Informação, UNOESC, Chapecó}\sep\email{aluno2@edu.unoesc.br}} \and
  Jessé Chaves\thanks{\affil{Curso de Sistemas de Informação, UNOESC, Chapecó}\sep\email{aluno3@edu.unoesc.br}} \and
  Lucas Santos Magro\thanks{\affil{Curso de Sistemas de Informação, UNOESC, Chapecó}\sep\email{aluno4@edu.unoesc.br}} \and
...
% --- Elementos pré-textuais (Capa, Resumo) ---
\pretextual
...
% --- Início do conteúdo textual do trabalho ---
\textual
\newpage
...
%% ===================================================================
%% SEÇÃO DE DELIMITAÇÃO DO TEMA E JUSTIFICATIVA
%% ===================================================================
